...
response <- read.xlsx("./analysis/data/CCCM_SiteReporting_All Internal (WithID)_2020-05-26.xlsx")
...
dap <- load_analysisplan("./analysis/data analysis plan/cccm_analysis_plan_v3_governorate.csv")
...
write.csv(data_merge, paste0("./analysis/output/governorate_data_merge_",today,".csv"), row.names = F)                     
browseURL(paste0("./analysis/output/cccm_governorate_full_merge_",today,".csv"))
